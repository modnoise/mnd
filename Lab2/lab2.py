...
if ruv[0] > r_kr or ruv[1] > r_kr or ruv[2] > r_kr:
    ...
    my = (averageY[0] + averageY[1] + averageY[2]) / 3

    a1 = (xn[0][0] ** 2 + xn[1][0] ** 2 + xn[2][0] ** 2) / 3
    a2 = (xn[0][0] * xn[0][1] + xn[1][0] * xn[1][1] + xn[2][0] * xn[2][1]) / 3
    a3 = (xn[0][1] ** 2 + xn[1][1] ** 2 + xn[2][1] ** 2) / 3
    a11 = (xn[0][0] * averageY[0] + xn[1][0] * averageY[1] + xn[2][0] * averageY[2]) / 3
    a22 = (xn[0][1] * averageY[0] + xn[1][1] * averageY[1] + xn[2][1] * averageY[2]) / 3
    ...
    print("Середні значення:", averageY[0], averageY[1], averageY[2])
